...
%   min_convergence_value: Convergence criteria for gradinet size. (default = 1e-5)
  ...
  filename = 'BuckleBeam_y1_mesh4-50_BITSS_alpha10_beta01_dist005-005_re1e-8_iter3_springstiff_dist0.txt';
  ...
  filename = 'BuckleBeam_y1_mesh4-50_BITSS_pt1_alpha10_beta01_dist005-005_re1e-8_iter3_Interm_dist0.txt';
  fid = fopen(filename,'at');
  for ii = 1:ndof
      fprintf(fid,'%.12f\n',x1(ii));
  end
  ...
  filename = 'BuckleBeam_y1_mesh4-50_BITSS_pt2_alpha10_beta01_dist005-005_re1e-8_iter3_Interm_dist0.txt';
  fid = fopen(filename,'at');
  for ii = 1:ndof
      fprintf(fid,'%.12f\n',x2(ii));
  end
  ...
  %%% Run
  abaqusfile = 'Data_Files\BuckleBeam_y1_Left_mesh4-50.inp'; % Input node and element information
