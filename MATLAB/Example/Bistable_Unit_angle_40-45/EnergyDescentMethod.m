%%% Energy Descent Method initiated at BITSS images for NEB initial guess 
clear;
clc
...
% initial guess can either be xy_BITSS1 or xy_BITSS2
%%%

nn = size(interm,2); % number of iteration during energy descent method

for ii = 1:nn   % plot all the intermediate states during energy descent method 
...
filename = 't06_L5_theta40-45_twobeam_mesh4-50_mu1_lambda3_E100_nu03_EnergyDescent_dist005-005_BITSS1_Re1e-5.txt';
